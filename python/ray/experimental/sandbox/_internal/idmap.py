...
This module detects whether the node can do that and offers a throwaway
mapped namespace for work on subordinate-owned trees; the holder script in
``backend/gvisor.py`` performs the mapping for sandboxes.
"""
